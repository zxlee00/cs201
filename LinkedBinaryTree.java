...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public static void main(String[] args){
    LinkedBinaryTree<Integer> btree = new LinkedBinaryTree<Integer>();
    Node<Integer> root = (Node<Integer>) btree.addRoot(0);
    ...
    for(Position<Integer> pos : btree.inorder())
      System.out.print(pos.getElement() + " ");
    System.out.println();
    
    System.out.print("preorder: ");
    for(Position<Integer> pos : btree.preorder())
      System.out.print(pos.getElement() + " ");
    System.out.println();

    System.out.print("postorder: ");
    for(Position<Integer> pos : btree.postorder())
      System.out.print(pos.getElement() + " ");
    System.out.println();
